...
class Group {
    ...
    var groupID: String! // The (firebase) unique ID for this group in the database, generated by .childByAutoID()
    var groupName: String // The non-unique name for this group
    //var internalGroupName: String! //this could still be the same as the groupName sometimes
    var groupIcon: UIImage // The icon, or "profile photo", for this group
    ...
    init(groupID: String, groupName: String, image: UIImage, creationDate: Date) {
        self.groupID = groupID
        self.groupName = groupName
        self.groupIcon = image
    ...
    init(groupID: String, groupName: String, image: UIImage, users: [User], creator: User, creationDate: Date) {
        self.groupID = groupID
        self.groupName = groupName
        self.groupIcon = image
        self.members = users
